...
import { nurseApi, type AppointmentDetail } from "@/api";

interface AppointmentDetailModalNurseProps {
  isOpen: boolean;
  onClose: () => void;
  appointmentId: string | null;
}

const AppointmentDetailModalNurse = ({
  isOpen,
  onClose,
  appointmentId,
}: AppointmentDetailModalNurseProps) => {
  ...
  const fetchAppointmentDetail = async () => {
    ...
    try {
      setLoading(true);
      setError(null);
      const res = await nurseApi.getAppointmentDetail(appointmentId);
...
export default AppointmentDetailModalNurse;
